...
//        this.turret = turret;
    ...
    /**
     * Standard heading mirror for RED alliance.
     * Formula: (360 - blueHeading) % 360
     * Use for: SetInitialPoseCommand heading.
     */
    private double h(double blueHeading) {
        if (!isRed) return blueHeading;
        return (360.0 - blueHeading) % 360.0;
    }

    /**
     * Standard follow angle mirror. Reflects across the 90° (Forward) axis for the RED alliance.
     * This keeps "Forward" as 90° and "Backward" as -90° for both alliances.
     * Use for: All FollowPathCommand follow angles.
     */
    private double fa(double blueDegrees) {
        if (!isRed) return Math.toRadians(blueDegrees);

        // Reflection across 90° axis: 180 - degrees
        double redDegrees = 180.0 - blueDegrees;

        // Normalize to (-180, 180] range
        while (redDegrees > 180)  redDegrees -= 360;
        while (redDegrees <= -180) redDegrees += 360;

        return Math.toRadians(redDegrees);
    }
...
//        commonFarInit();
        boolean debug = true;
        scheduler.add(new SetInitialPoseCommand(-62.04, y(14.00), h(0.00)));
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot first 3 Balls"));
        ...
        driveToCornerA.add(new CurvePoint(-50.70, y(44.22), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
        driveToCornerA.add(new CurvePoint(-50.70, y(55.50), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
        scheduler.add(new FollowPathCommand(driveToCornerA, fa(115), debug, 4)
...
//        scheduler.add(new FollowPathCommand(pathToHome, fa(-90), debug)
//                .withName("Drive home"));
        ...
        scheduler.add(new FollowPathCommand(driveToCornerB, fa(-90), debug, 2)
        ...
        scheduler.add(new FollowPathCommand(driveToCornerC, fa(90), debug, 2)
...
//        scheduler.add(new FollowPathCommand(driveToCornerD, fa(-90), debug, 2)
...
//        scheduler.add(new FollowPathCommand(driveToCornerE, fa(90), debug, 2)
...
//        scheduler.add(new WaitCommand(0.3));
        ...
        scheduler.add(new FollowPathCommand(driveToShoot2, fa(180), debug)
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot second 3 Balls"));
        ...
        scheduler.add(new FollowPathCommand(pathToSpike1, fa(90), debug).withName("Drive to Spike 1"));
        ...
        scheduler.add(new FollowPathCommand(pathToShot3, fa(-90), debug)
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot third 3 Balls"));
        ...
        scheduler.add(new FollowPathCommand(driveToCornerH, fa(115), debug, 4)
        ...
        scheduler.add(new FollowPathCommand(driveToCornerI, fa(-90), debug, 2)
        ...
        scheduler.add(new FollowPathCommand(driveToShoot4, fa(180), debug)
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
    ...
    public void buildAleTest() {
        boolean debug = true;
        scheduler.add(new SetInitialPoseCommand(-62.04, y(14.00), h(180.00)).withName("Start Pose"));
        ArrayList<CurvePoint> path1 = new ArrayList<>();
        path1.add(new CurvePoint(-62.04, y(14.00), 1.00, 1.00, 5.00, Math.toRadians(60.0), 1.00));
        path1.add(new CurvePoint(-54.90, y(11.88), 1.00, 1.00, 5.00, Math.toRadians(60.0), 1.00));
        path1.add(new CurvePoint(-16.56, y(1.44), 0.80, 1.00, 5.00, Math.toRadians(60.0), 1.00));
        ...
        path2.add(new CurvePoint(-16.56, y(1.44), 1.00, 0.40, 10.00, Math.toRadians(60.0), 0.60));
        path2.add(new CurvePoint(-5.76, y(18.18), 1.00, 0.40, 7.50, Math.toRadians(60.0), 0.60));
        path2.add(new CurvePoint(-13.86, y(38.88), 1.00, 0.40, 6.30, Math.toRadians(60.0), 0.60));
        path2.add(new CurvePoint(-50.70, y(44.22), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
        path2.add(new CurvePoint(-50.70, y(55.50), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
        scheduler.add(new FollowPathCommand(path2, fa(115.00), debug)
                .transitionImmediately()
                .withName("Drive to Corner A"));

        scheduler.add(new WaitCommand(0.3));
        scheduler.add(new IntakeCommand(Intake.IntakeState.REVERSE));
        scheduler.add(new WaitCommand(3.0));
        scheduler.add(new IntakeCommand(Intake.IntakeState.OFF).withName("Intake OFF"));
        ArrayList<CurvePoint> path3 = new ArrayList<>();
        path3.add(new CurvePoint(-50.70, y(55.50), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
        path3.add(new CurvePoint(-62.04, y(14.00), 1.00, 1.00, 5.00, Math.toRadians(60.0), 1.00));
    ...
    public void bioBuzzPracticeAuto() {
//        commonFarInit();
        boolean debug = true;
        scheduler.add(new SetInitialPoseCommand(14.00, y(61.00), h(270.00)));
...
//        scheduler.add(new FollowPathCommand(driveToCornerA, fa(115), debug, 2.5)
...
//        scheduler.add(new FollowPathCommand(driveToCornerF, fa(115), debug, 2)
//                .withName("Drive In Bump 3"));
//
////        scheduler.add(new WaitCommand(.3));
//
...
//        scheduler.add(new FollowPathCommand(driveToCornerG, fa(-90), debug, 2)
//                .withName("Drive Out Bump 3"));
//
...
//        driveToCornerH.add(new CurvePoint(-54.54, y(50.04), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
//        driveToCornerH.add(new CurvePoint(-58.68, y(62.46), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
//        scheduler.add(new FollowPathCommand(driveToCornerH, fa(115), debug, 2)
...
//        scheduler.add(new FollowPathCommand(pathToShot2, fa(180), debug)
//                .withName("Drive to Shoot Spot 2"));
//
//        scheduler.add(new SetShooterPreloadModeCommand().withName("set to preload"));
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot second 3 Balls"));
...
//        scheduler.add(new FollowPathCommand(pathToSpike2a, fa(0), debug, 8).withName("Drive to Spike 2a"));
//
...
//        scheduler.add(new FollowPathCommand(pathToSpike2b, fa(90), debug, 8).withName("Drive to Spike 2b"));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToShot3, fa(180), debug, 5)
...
//        scheduler.add(new FollowPathCommand(pathToShot2, fa(180), debug).withName("Drive to Shoot Spot 2"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot Second 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(pathToSpike1A, fa(90), debug).withName("Drive to Spike 1A"));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToSpike2b, fa(90), debug, 2).withName("Drive to Spike 2b"));
//
//        ArrayList<CurvePoint> pathToShot2 = new ArrayList<>();
//        pathToShot2.add(new CurvePoint(-5.04, y(54.54), 1.00, 1.00, 10.00, Math.toRadians(60.0), 0.60));
...
//        scheduler.add(new FollowPathCommand(pathToGate2, fa(90), debug, 3.5).withName("Drive to Open Gate 2"));
//
//        scheduler.add(new WaitCommand(1.5));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToShot3, fa(180), debug).withName("Drive to Shoot Spot 3"));
//
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot Third 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(pathToShot4, fa(180), debug, 5)
//                .transitionWhenDistancetoEndIsLessThan(20)
...
//        scheduler.add(new AutoIntakeCommand(fa(90), false, 3.0, 0.0, 60.0)
...
//        scheduler.add(new FollowPathCommand(driveToShoot3, fa(headingShoot3), debug)
//                .withName("Drive to Shoot spot 3"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(driveToShoot4, fa(headingShoot4), debug)
//                .withName("Drive to Shoot spot 4"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
//
...
//        intake.setIntakeRoller(true);
        ...
        Pose2D initialPose = new Pose2D(DistanceUnit.INCH, -62.04, y(14.00), AngleUnit.DEGREES, h(0.00));
...
//        intake.setIntakeRoller(true);
//
//        Pose2D initialPose = new Pose2D(DistanceUnit.INCH, 41.04, y(54.54), AngleUnit.DEGREES, h(-90));
//        drivetrain.setPosition(initialPose);
...
//
    private void commonFarTeardown() {
        ...
        scheduler.addTeardown(new FollowPathCommand(pathToPark, fa(90), debug)
...
//
//        // 7. Begin Husky Chase 1
//        scheduler.add(new AutoIntakeCommand(fa(100), false, 3.0, 0.0, 60.0)
//                .withName("Intake with Husky"));
//
//        // 8. Drive to Shoot 3
//        ArrayList<CurvePoint> driveToShoot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(driveToShoot5, fa(-90), debug)
//                .withName("Drive to Shoot spot 4"));
//
