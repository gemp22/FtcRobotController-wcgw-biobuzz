...
//        this.turret = turret;
    ...
    /**
     * Standard heading mirror. Reflects across the 90° (Forward) axis for the RED alliance.
     * This keeps "Forward" as 90° and "Backward" as -90° for both alliances.
     * Use for: All FollowPathCommand headings.
     */
    private double h(double blueDegrees) {
...
//        scheduler.add(new SetShooterPreloadModeCommand().withName("set to preload"));
        ...
        scheduler.add(new FollowPathCommand(pathToShoot, h(90), debug)
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot first 3 Balls"));
        ...
        scheduler.add(new FollowPathCommand(driveToCornerA, h(115), debug, 4)
...
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
    ...
    public void buildAleTest() {
        ...
        scheduler.add(new FollowPathCommand(path1, h(90.00), debug)
        ...
        scheduler.add(new FollowPathCommand(path2, h(115.00), debug)
                .transitionImmediately()
                .withName("Drive to Corner A"));
        ...
        scheduler.add(new FollowPathCommand(path3, h(-90.00), debug)
                .transitionImmediately()
                .withName("Drive home"));
...
//        commonFarInit();
        boolean debug = true;
        scheduler.add(new SetInitialPoseCommand(14.00, y(61.00), 90.00));
...
//        scheduler.add(new FollowPathCommand(driveToCornerA, h(115), debug, 2.5)
...
//        scheduler.add(new FollowPathCommand(driveToCornerF, h(115), debug, 2)
//                .withName("Drive In Bump 3"));
//
////        scheduler.add(new WaitCommand(.3));
//
...
//        scheduler.add(new FollowPathCommand(driveToCornerG, h(-90), debug, 2)
//                .withName("Drive Out Bump 3"));
//
...
//        driveToCornerH.add(new CurvePoint(-54.54, y(50.04), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
//        driveToCornerH.add(new CurvePoint(-58.68, y(62.46), 1.00, 0.40, 5.00, Math.toRadians(60.0), 0.60));
//        scheduler.add(new FollowPathCommand(driveToCornerH, h(115), debug, 2)
...
//        scheduler.add(new FollowPathCommand(pathToShot2, h(180), debug)
//                .withName("Drive to Shoot Spot 2"));
//
//        scheduler.add(new SetShooterPreloadModeCommand().withName("set to preload"));
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot second 3 Balls"));
...
//        scheduler.add(new FollowPathCommand(pathToSpike2a, h(0), debug, 8).withName("Drive to Spike 2a"));
//
...
//        scheduler.add(new FollowPathCommand(pathToSpike2b, h(90), debug, 8).withName("Drive to Spike 2b"));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToShot3, h(180), debug, 5)
...
//        scheduler.add(new FollowPathCommand(pathToShot2, h(180), debug).withName("Drive to Shoot Spot 2"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot Second 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(pathToSpike1A, h(90), debug).withName("Drive to Spike 1A"));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToSpike2b, h(90), debug, 2).withName("Drive to Spike 2b"));
//
//        ArrayList<CurvePoint> pathToShot2 = new ArrayList<>();
//        pathToShot2.add(new CurvePoint(-5.04, y(54.54), 1.00, 1.00, 10.00, Math.toRadians(60.0), 0.60));
...
//        scheduler.add(new FollowPathCommand(pathToGate2, h(90), debug, 3.5).withName("Drive to Open Gate 2"));
//
//        scheduler.add(new WaitCommand(1.5));
//
//        ArrayList<CurvePoint> pathToShot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(pathToShot3, h(180), debug).withName("Drive to Shoot Spot 3"));
//
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot Third 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(pathToShot4, h(180), debug, 5)
//                .transitionWhenDistancetoEndIsLessThan(20)
...
//        scheduler.add(new AutoIntakeCommand(h(90), false, 3.0, 0.0, 60.0)
...
//        scheduler.add(new FollowPathCommand(driveToShoot3, h(headingShoot3), debug)
//                .withName("Drive to Shoot spot 3"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
//
...
//        scheduler.add(new FollowPathCommand(driveToShoot4, h(headingShoot4), debug)
//                .withName("Drive to Shoot spot 4"));
//
//        scheduler.add(new Shoot3BallsCommand().withName("Shoot fourth 3 Balls"));
//
...
//
    private void commonFarTeardown() {
        ...
        scheduler.addTeardown(new FollowPathCommand(pathToPark, h(90), debug)
...
//
//        // 7. Begin Husky Chase 1
//        scheduler.add(new AutoIntakeCommand(h(100), false, 3.0, 0.0, 60.0)
//                .withName("Intake with Husky"));
//
//        // 8. Drive to Shoot 3
//        ArrayList<CurvePoint> driveToShoot3 = new ArrayList<>();
...
//        scheduler.add(new FollowPathCommand(driveToShoot5, h(-90), debug)
//                .withName("Drive to Shoot spot 4"));
//
